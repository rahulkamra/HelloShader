...
#pragma fragment frag
	...
	vertexOut vert(vertexIn vi)
	{
		...
		vo.inpPosition = normalize(_WorldSpaceCameraPos.xyz - mul(_Object2World, vo.inpPosition).xyz);
		vo.normal = vi.normal;
		vo.uv = vi.uv;
	...
	fixed4 frag(vertexOut vo) : COLOR
	{
		...
		float3 viewDirection = vo.inpPosition.xyz;
